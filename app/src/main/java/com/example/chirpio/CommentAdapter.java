...
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Comments p=commentlist.get(position);
        mvh.tv1.setText(p.getName());
        mvh.tv2.setText(p.getDate());
        mvh.tv3.setText(p.getComment());
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tv1 = itemView.findViewById(R.id.prev_cmt_username);
            tv2 = itemView.findViewById(R.id.prev_cmt_date);
            tv3 = itemView.findViewById(R.id.prev_cmt_thought);
        }
    }
}